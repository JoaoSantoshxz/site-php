...
<head>
    ...
    <title>AKROFISIO - Fisioterapia Ortopédica</title>
    ...
    <style>
        ...
        /* Estilos específicos para a página de Fisioterapia Ortopédica */
        .hero-fisioterapia {
            background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('https://placehold.co/1920x600/000/fff?text=Fisioterapia+Ortopédica') no-repeat center center/cover;
            color: var(--text-light);
            text-align: center;
            padding: 100px 20px;
            position: relative;
...
<body>
        ...
        <div class="container">
            ...
            <nav class="main-nav">
                <ul id="nav-list">
                    ...
                    <li><a href="desportivo.php">Fisioterapia Desportiva</a></li>
    ...
    <main>
        <section class="hero-fisioterapia">
            <div class="container">
                <h1>Fisioterapia Ortopédica</h1>
                <p>Prepare-se para Dizer Adeus às Dores e Olá à Liberdade! Sabe aquela dorzinha chata no joelho que insiste em te seguir depois daquele futebol? Ou o ombro que range quando você tenta pegar algo no alto? E a coluna que vive reclamando depois de um dia de trabalho? Se você respondeu sim para alguma dessas perguntas, então a fisioterapia ortopédica é a sua melhor amiga na missão de dar um "chega pra lá" nessas dores!</p>
            </div>
        </section>

        <section class="content-section">
            <div class="container">
                <h2>O Que É Essa Fisioterapia Mágica?</h2>
                <div class="content-block">
                    <div class="text-content">
                        <h3>O Engenheiro do Movimento!</h3>
                        <p>Imagine seu corpo como uma supermáquina, cheia de engrenagens, fios e amortecedores (seus músculos, ossos, ligamentos e articulações). Às vezes, alguma peça dessa máquina se desalinha, se desgasta ou simplesmente resolve tirar férias e parar de funcionar direito. É aí que entra o fisioterapeuta ortopédico, o engenheiro do movimento!</p>
                        <p>Ele não só te ajuda a consertar o que está "quebrado", mas também te ensina a cuidar da sua máquina para que ela funcione no máximo da sua potência por muito e muito tempo! É como ter um personal trainer exclusivo para seus ossos e músculos, que te guia em exercícios superinteligentes para:</p>
                        <ul>
                            <li>Acabar com a dor: Chega de viver à base de analgésicos! A fisioterapia vai na raiz do problema.</li>
                            <li>Devolver a sua mobilidade: Quer voltar a dançar, correr, levantar peso ou simplesmente amarrar o tênis sem sentir dor? A fisio te dá essa liberdade de volta!</li>
                            <li>Fortalecer seus "pontos fracos": Sabe aqueles músculos preguiçosos que não fazem a parte deles? Vamos acordá-los e deixá-los fortes como rocha!</li>
                            <li>Prevenir futuras "panes": Melhor prevenir do que remediar, certo? Com a fisio, você aprende a evitar novas lesões e a manter seu corpo blindado.</li>
                            <li>Melhorar sua postura: Diga adeus àquela "corcunda" e sinta-se mais alto e confiante!</li>
                        </ul>
                    </div>
                    <div class="image-content">
                        <img src="imagem/ort1.jpg" alt="[Image of Pessoa com eletroterapia no joelho]">
                    </div>
                </div>

                <div class="content-block inverted">
                    <div class="text-content">
                        <h3>Como Funciona Essa "Jornada do Herói" Contra a Dor?</h3>
                        <p>Nada de fórmulas mágicas ou tratamentos chatos! A fisioterapia ortopédica é uma jornada personalizada e divertida:</p>
                        <ul>
                            <li>A Entrevista Detetivesca: O fisioterapeuta vai te fazer um monte de perguntas para entender exatamente o que está acontecendo com seu corpo. É como um Sherlock Holmes da sua dor!</li>
                            <li>A Avaliação Ninja: Ele vai testar seus movimentos, força e flexibilidade para descobrir os pontos fracos e os vilões da sua história.</li>
                            <li>O Plano de Batalha Personalizado: Com base na avaliação, ele cria um plano de exercícios feito sob medida para você. Pode ter exercícios na maca, na bola, com elásticos, e até usando equipamentos de alta tecnologia.</li>
                            <li>A Execução com Orientação VIP: Você não vai fazer nada sozinho! O fisioterapeuta te acompanha em cada exercício, corrigindo sua postura e garantindo que você faça tudo direitinho para ter os melhores resultados.</li>
                            <li>A Celebração da Vitória: A cada sessão, você vai sentir a melhora, ganhando mais movimento, menos dor e mais qualidade de vida!</li>
                        </ul>
                    </div>
                    <div class="image-content">
                        <img src="imagem/ort3.jpg" alt="[Image of Fisioterapeuta auxiliando paciente com bola de exercícios]">
                    </div>
                </div>

                <div class="content-block">
                    <div class="text-content">
                        <h3>Para Quem é a Fisioterapia Ortopédica?</h3>
                        <p>Para TODO MUNDO que tem:</p>
                        <ul>
                            <li>Dores nas costas, pescoço, ombros, joelhos, tornozelos, pés, mãos... (ufa, em qualquer lugar!)</li>
                            <li>Lesões esportivas (aquela torção no futebol, o ombro doendo depois da natação)</li>
                            <li>Pós-operatório (para se recuperar rapidinho de cirurgias ortopédicas)</li>
                            <li>Artrite, artrose e outras condições reumáticas</li>
                            <li>Problemas de postura</li>
                            <li>Ou simplesmente quer prevenir problemas e viver uma vida mais ativa e sem limitações!</li>
                        </ul>
                    </div>
                    <div class="image-content">
                        <img src="imagem/ort2.jpg" alt="[Image of Pessoa com dor no joelho com destaque para o osso]">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="benefits-section">
            <div class="container">
                <h2>Benefícios da Fisioterapia Ortopédica</h2>
                <div class="benefits-grid">
                    <div class="benefit-item">
                        <i class="fas fa-stethoscope"></i>
                        <h3>Redução da Dor</h3>
                        <p>Alívio efetivo de dores agudas e crônicas, permitindo que você retome suas atividades com conforto.</p>
                    </div>
                    <div class="benefit-item">
                        <i class="fas fa-running"></i>
                        <h3>Melhora da Mobilidade e Flexibilidade</h3>
                        <p>Restauração da amplitude de movimento das articulações e aumento da flexibilidade muscular.</p>
                    </div>
                    <div class="benefit-item">
                        <i class="fas fa-fist-raised"></i>
                        <h3>Aumento da Força Muscular</h3>
                        <p>Fortalecimento direcionado para o suporte, estabilidade e função ideal dos músculos.</p>
                    </div>
                    <div class="benefit-item">
                        <i class="fas fa-shield-alt"></i>
                        <h3>Prevenção de Reincidências</h3>
                        <p>Educação e programas de exercícios para evitar novas lesões e manter a saúde a longo prazo.</p>
                    </div>
                    <div class="benefit-item">
                        <i class="fas fa-undo-alt"></i>
                        <h3>Retorno às Atividades</h3>
                        <p>Auxílio para retomar suas atividades diárias, esportivas e de lazer de forma segura e eficaz.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="fisioterapia-cta">
            <div class="container">
                <h2>Pronto para se Movimentar Sem Limites?</h2>
                <p>Então, se você está cansado de ser refém da dor e quer retomar o controle do seu corpo, a fisioterapia ortopédica é o caminho! Prepare-se para se movimentar sem limites, sorrir mais e viver a vida que você merece! Que tal agendar uma avaliação e começar sua transformação?</p>
                <a href="agenda.php" class="button">Agendar Consulta</a>
            </div>
        </section>
    </main>
